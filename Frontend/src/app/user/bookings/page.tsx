...
export default function BookingsPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      <div>
        <h1 className="text-2xl font-bold text-[#1E2A4F]">Pesanan Saya</h1>
        <p className="text-gray-500 text-sm mt-1">Lihat dan kelola semua pesanan Anda sebelumnya dan yang akan datang.</p>
        {error && (
